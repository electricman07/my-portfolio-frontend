...
export function ContactCTA() {
  return (
    <section
      className="relative group overflow-hidden p-12 md:p-20 rounded-[3rem] 
                        bg-blue-600 dark:bg-blue-700 border-4 border-white dark:border-slate-800 
                        shadow-[0_20px_50px_rgba(59,130,246,0.3)] text-center text-white"
    >
