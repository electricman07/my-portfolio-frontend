    ...
    <div className="max-w-7xl mx-auto px-6 py-20 space-y-20 animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-slate-200 dark:border-slate-800 pb-8">
        ...
        <select
          ...
          className="px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 outline-none focus:ring-2 focus:ring-blue-500"
        >
          ...
          {pageCount > 1 && (
            <div className="flex items-center justify-center gap-4 pt-8 border-t border-slate-100 dark:border-slate-800">
              <button
                ...
                className="p-2 rounded-lg border border-slate-200 dark:border-slate-800  hover:bg-blue-50 dark:hover:bg-blue-950/30 text-slate-700 dark:text-slate-300 hover:text-blue-600 transition-colors disabled:opacity-30"
              >
                <ChevronLeft size={20} />
              </button>
