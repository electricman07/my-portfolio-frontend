...
function ContactComponent() {
  return (
    <div className="py-12 max-w-6xl mx-auto  space-y-12 animate-in fade-in duration-700">
      {/* Page Introduction */}
      <header className="max-w-3xl space-y-4 px-4 text-center mx-auto">
      ...
      <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-start px-4 md:px-6 mx-auto w-full max-w-full overflow-hidden">
