    ...
    <div className="max-w-5xl mx-auto py-20 px-6 space-y-16 animate-in fade-in slide-in-from-bottom-10 duration-1000">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <h3 className="text-3xl font-black tracking-tight mb-4 text-slate-950 dark:text-white">
            Send a Message
          </h3>
          <p className="text-slate-800 dark:text-slate-400 font-medium mb-8">
            Best for general inquiries, quotes, or just saying hello. I'll get
            back to you within 24 hours.
          </p>
          <span className="inline-flex items-center gap-2 text-blue-600 font-black uppercase tracking-widest text-xs group-hover:gap-4 transition-all">
        ...
        >
          ...
          <span className="inline-flex items-center gap-2 text-slate-900 dark:text-white font-black uppercase tracking-widest text-xs group-hover:gap-4 transition-all">
      ...
      <div className="group p-10 bg-white dark:bg-slate-950 border-2 border-slate-200 dark:border-slate-800 rounded-[3rem] shadow-xl">
        ...
        >
          Request a Meeting <ArrowRight size={16} strokeWidth={3} />
        </Link>
      </div>
